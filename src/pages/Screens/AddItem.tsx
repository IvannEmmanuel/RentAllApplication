...
//         deposit_fee: form.deposit_fee ? parseFloat(form.deposit_fee) : 0,
...
//           const path = `${currentUser.id}/${itemId}/${Date.now()}-${imageFile.name}`
...
//                 .eq('item_id', itemId)
//               if (updateErr) {
//                 console.error('Failed to update item with image:', updateErr.message)
//               }
//             }
//           }
//         } catch (imageError) {
...
//       Alert.alert(
//         'Success',
//         'Item created successfully' + (publicUrl ? ' (image uploaded)' : ''),
//         [{ 
//           text: 'OK', 
//           onPress: () => {
//             // Reset form
